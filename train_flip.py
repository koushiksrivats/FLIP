...
from fas import flip_it, flip_v
import random
import numpy as np
...
def train(config):
  # 5-shot
  src1_train_dataloader_fake, src1_train_dataloader_real, src2_train_dataloader_fake, src2_train_dataloader_real, src3_train_dataloader_fake, src3_train_dataloader_real, _, _, src5_train_dataloader_fake, src5_train_dataloader_real, test_dataloader = get_dataset( # for wcs
  ...
  # # src1_train_dataloader_fake, src1_train_dataloader_real, src2_train_dataloader_fake, src2_train_dataloader_real, src3_train_dataloader_fake, src3_train_dataloader_real, src4_train_dataloader_fake, src4_train_dataloader_real, test_dataloader = get_dataset(
  #     config.src1_data, config.src1_train_num_frames, config.src2_data,
  #     config.src2_train_num_frames, config.src3_data,
  #     config.src3_train_num_frames, config.src4_data,
  #     config.src4_train_num_frames, config.src5_data,
  ...
  # # 1-1 setting
  # # src1_train_dataloader_fake, src1_train_dataloader_real, src2_train_dataloader_fake, src2_train_dataloader_real, _, _, test_dataloader = get_dataset_one_to_one(
  ...
  if train_method == 'flip_it':
    # FLIP-IT
    net1 = flip_it().to(device)
  elif train_method == 'flip_v':
    # FLIP-V
